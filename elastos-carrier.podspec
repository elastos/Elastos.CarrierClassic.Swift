...
Pod::Spec.new do |s|
  ...
  s.source       = {'http':'https://github.com/elastos/Elastos.NET.Carrier.iOS.SDK/releases/download/release-v5.2.2/ElastosCarrier-framework.zip'}
  ...
  s.preserve_paths = 'ElastosCarrier-framework/CocoaPods/*'
